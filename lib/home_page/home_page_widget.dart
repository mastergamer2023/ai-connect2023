                            ...
                            Padding(
                              ...
                              child: AuthUserStreamWidget(
                                builder: (context) => InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'HOME_PAGE_PAGE_Text_vd3n1qms_ON_TAP');
                        ...
                        Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'HOME_PAGE_PAGE_Container_5i212w0e_ON_TAP');
                          ...
                          itemBuilder: (context, listViewIndex) {
                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'HOME_PAGE_PAGE_Container_ptpukrzh_ON_TAP');
                                  logFirebaseEvent('Container_navigate_to');
                                  ...
                                  itemBuilder: (context, listViewIndex) {
                                    ...
                                    return Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'HOME_PAGE_PAGE_Container_63q4y52f_ON_TAP');
                                          logFirebaseEvent(
